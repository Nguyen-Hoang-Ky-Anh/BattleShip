...
4. Hệ thống khởi tạo AI tương ứng với độ khó đã chọn.
...
|-----------------|--------|
| **Use Case ID** | UC-07.3 |
| **Use Case Name** | Share Room |
| **Created By** | Nguyễn Hoàng Kỳ Anh |
| **Date Created** | 22/04/2026 |
| **Actor** | User (Host) |

**Description:**
Host chia sẻ Room ID hoặc link phòng cho người khác.

**Preconditions:**
- Phòng đã được tạo.

**Postconditions:**
- Room ID / link được chia sẻ.

**Main Flow:**
1. Host chọn "Share Room".
2. System hiển thị Room ID / link.
3. Host copy hoặc chia sẻ qua nền tảng khác.
